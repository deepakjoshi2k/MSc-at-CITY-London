...
* **Visualization:** Creating a similar superimposed line plot using `alt.Chart().mark_line()` to visualize available bikes vs. hour.

### Task 2.3: Altair for Spatial Analysis (Glyph Maps)

* **Map Creation:** Using Altair to create a **spatial map** where each station is represented by a circle (`mark_circle`).
